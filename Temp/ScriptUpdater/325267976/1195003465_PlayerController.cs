...
public class PlayerController : MonoBehaviour
{
    ...
    public float currentCharge = 0f; // Fuerza acumulada actual
    public bool isCharging = false; // Indicador de si se está acumulando fuerza
    private Vector2 currentDirection = Vector2.right; // Dirección actual por defecto
